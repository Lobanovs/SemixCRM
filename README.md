...
Тесты покрывают SQLite, архив и восстановление, расписание, дедупликацию, API фриланса, адаптеры источников, Telegram, управление снайпером, историю запусков и автоматическую подготовку изолированного 2GIS-runtime.
